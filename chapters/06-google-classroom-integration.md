...
<!-- → [INFOGRAPHIC: Five-step verification checklist as a visual sequence — Step 1: Log in as test student. Step 2: Open Classroom. Step 3: Look for NotebookLM icon. Step 4: Click into teacher-created notebook. Step 5: Run a query and confirm citations. Style: clean numbered steps, each with a one-line description. Caption: "Run this the week before the lesson. Not the night before."] -->
...
<!-- → [INFOGRAPHIC: Timeline of NotebookLM Classroom rollout phases — September 2025 and April 2026 marked on a horizontal timeline. For each phase: what became available, who it applies to (all ages / 18+ only). Annotate the gap between phases with "K–12 students remain on the September 2025 model." Caption: "Which phase applies to your students determines what your assignments can ask them to do."] -->
